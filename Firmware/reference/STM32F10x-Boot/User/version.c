...
const char cVersionHardBuff[32] __attribute__ ((section(".ARM.__at_0x08000800"))) = VERSION_BOOT_HARDWARE;
const char cVersionSoftBuff[32] __attribute__ ((section(".ARM.__at_0x08000820"))) = VERSION_BOOT_SOFTWARE;
const char cVersionDateBuff[32] __attribute__ ((section(".ARM.__at_0x08000840"))) = __DATE__" - "__TIME__;
const char cVersionTypeBuff[32] __attribute__ ((section(".ARM.__at_0x08000860"))) = "MySTM32";
