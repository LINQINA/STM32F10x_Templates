...
typedef enum { 
    ...
    BEEP_DISABLE,                /* 关闭 */
    BEEP_ENABLE,                 /* 常响 */
    BEEP_FLASH_SLOW,             /* 循环慢响(0.5Hz) */
    BEEP_FLASH_SLOW_ENABLE_CNT,  /* 慢响N次后BEEP常响 */
    BEEP_FLASH_SLOW_DISABLE_CNT, /* 慢响N次后BEEP关闭 */
    BEEP_FLASH_FAST,             /* 循环快响(1Hz) */
    BEEP_FLASH_FAST_ENABLE_CNT,  /* 快响N次后BEEP常响 */
    BEEP_FLASH_FAST_DISABLE_CNT, /* 快响N次后BEEP关闭 */
} BeepStateEnum;
