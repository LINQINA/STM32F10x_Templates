...
typedef enum {
    ...
    /* 固件 */
    Modbus_Register_Addr_Firmware_Software          = 0x0040,   /* 固件软件版本 */
    Modbus_Register_Addr_Firmware_Hardware          = 0x0048,   /* 固件硬件版本 */
    Modbus_Register_Addr_Firmware_Length            = 0x0050,   /* 固件长度 */
    Modbus_Register_Addr_Firmware_CRC               = 0x0052,   /* 固件CRC校验值 */
    Modbus_Register_Addr_Firmware_State             = 0x0054,   /* 固件烧写状态 */
    Modbus_Register_Addr_Firmware_Pack              = 0x0055,   /* 固件烧写数据包 */
    ...
    Modbus_Register_Addr_ChannelA_Switch         = 0x0083,  /* 通道A开关状态 */
    ...
    Modbus_Register_Addr_ChannelA_PowerFactor    = 0x0089,  /* 通道A功率因数 */
    ...
    Modbus_Register_Addr_ChannelB_Temperature    = 0x0092,  /* 通道B温度 */
    Modbus_Register_Addr_ChannelB_Switch         = 0x0093,  /* 通道B开关状态 */
    ...
    Modbus_Register_Addr_ChannelB_PowerFactor    = 0x0099,  /* 通道B功率因数 */
    ...
    Modbus_Register_Addr_HLW8110_ChannelA_ElecQuantity        = 0x0103,   /* A通道电量 */
    Modbus_Register_Addr_HLW8110_ChannelA_ElecQuantity_Backup = 0x0104,   /* A通道电量备份 */
    Modbus_Register_Addr_HLW8110_PowerFactory                 = 0x0105,   /* 功率因数 */
    ...
    Modbus_Register_Addr_HLW8110_ChannelB_ElecQuantity        = 0x0109,   /* B通道电量 */
    Modbus_Register_Addr_HLW8110_ChannelB_ElecQuantity_Backup = 0x010A,   /* B通道电量备份 */
    Modbus_Register_Addr_HLW8110_Frequency                    = 0x010B,   /* 线路频率 */
    Modbus_Register_Addr_HLW8110_CurrentChannel               = 0x010C,   /* 当前通道 */
